...
{
    private ConcurrentDictionary<Model.Bus, byte> _buses;
    ...
    /// </summary>
    public ConcurrentDictionary<Model.Bus, byte> Buses => _buses ??= new ConcurrentDictionary<Model.Bus, byte>();
    ...
    public bool Enter(Model.Bus bus)
    {
        bus.BusStation = this;
