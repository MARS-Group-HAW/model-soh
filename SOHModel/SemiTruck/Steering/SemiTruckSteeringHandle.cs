...
namespace SOHModel.SemiTruck.Steering
{
    ...
    public class SemiTruckSteeringHandle : VehicleSteeringHandle<ISemiTruckSteeringCapable, IPassengerCapable, SemiTruckSteeringHandle, SemiTruckPassengerHandle>
    {
        ...
        ///     Distance is computed via trapezoidal integration: d = (v₀ + v_new) / 2 × deltaT.
        /// </summary>
        ...
        /// <summary>Trapezoidal integration: d = (v₀ + v_new) / 2 × deltaT.</summary>
        ...
        ///     <c>Vehicle.Acceleration</c> to the true m/s² value consumed by the road-load fuel model.
        /// </summary>
        ...
        ///     d = (v₀ + v_new) / 2 × deltaT  →  v_new = 2d / deltaT − v₀
        /// </summary>
