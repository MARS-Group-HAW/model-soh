...
public class CITSTrafficLightLayer : AbstractActiveLayer
{
    ...
    public CITSTrafficLightLayer(CarLayer carLayer)
    {
        _carLayer = carLayer;
        ...
        UnregisterAgent? unregisterAgent = null)
    {
        ...
        string layerInitFile = layerInitData.LayerInitConfig.File;
        Logger.LogInfo("Traffic light layer initializing from file \"" + layerInitFile + "\"");

        //validation happens in the unzip method
        var inputDirectory = UnzipInputFile(layerInitFile);
