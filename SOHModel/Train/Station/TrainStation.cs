...
{
    private ConcurrentDictionary<Model.Train, byte> _trains;
    ...
    /// </summary>
    public ConcurrentDictionary<Model.Train, byte> Trains => _trains ??= new ConcurrentDictionary<Model.Train, byte>();
    ...
    public bool Enter(Model.Train train)
    {
